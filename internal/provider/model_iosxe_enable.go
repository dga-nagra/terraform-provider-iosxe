...
func (data Enable) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/enable=%s", url.QueryEscape(fmt.Sprintf("%v", data.Name.ValueString())))
}

func (data EnableData) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/enable=%s", url.QueryEscape(fmt.Sprintf("%v", data.Name.ValueString())))
}

// if last path element has a key -> remove it
func (data Enable) getPathShort() string {
	path := data.getPath()
...
func (data Enable) toBody(ctx context.Context) string {
...
func (data *Enable) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data *EnableData) fromBody(ctx context.Context, res gjson.Result) {
	prefix := helpers.LastElement(data.getPath()) + "."
	if res.Get(helpers.LastElement(data.getPath())).IsArray() {
		prefix += "0."
	}
...
func (data *Enable) getDeletedItems(ctx context.Context, state Enable) []string {
...
func (data *Enable) getEmptyLeafsDelete(ctx context.Context) []string {
	emptyLeafsDelete := make([]string, 0)
	return emptyLeafsDelete
}

func (data *Enable) getDeletePaths(ctx context.Context) []string {
